...
`)}if(i.size>0){try{await(await import("node:fs/promises")).mkdir(`${a}${e}`,{recursive:!0})}catch{console.log(`Could not create: ${a}${e}`)}try{await(await import("node:fs/promises")).writeFile(`${a}${e}${s}`,`${[...i].join("")}`)}catch{console.log(`Could not create workflow for: ${a}/dependabot.yml`)}}}})((await import("../Variable/Dependabot.js")).default);export{p as default};
