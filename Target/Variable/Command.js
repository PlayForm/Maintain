const i = new Set([
	...
	},
	{
		Name: "Edit",
		Arguments: new Set([
			{ Name: "[repositories...]", Description: "Repositories to edit." },
		]),
	...
	},
	{
		Name: "Complexity",
		Arguments: new Set([
			{ Name: "[files...]", Description: "Files to scan." },
		]),
	...
	},
	{
		...
		Action: async () =>
			i.forEach((t) => (t.Type === "Workflow" ? t.Action() : {})),
	},
	{
		Name: "Star",
...
var e = i;
export { i as Variable, e as default };
